...
public class ListProductTypeSizesDataParser extends AsyncTask<Void,Void,Integer> {
    Context c;
    ListView lv;
    String jsonData;
    ...
    public ListProductTypeSizesDataParser(Context c, ListView lv, String jsonData) {
        this.c = c;
        this.lv = lv;
    ...
    protected void onPostExecute(Integer result) {
        ...
        }else
        {
            ...
            final SizeTypeProductListAdapter adapter=new SizeTypeProductListAdapter(c,productTypeSizeDBDatas);
